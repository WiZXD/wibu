...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = SonelBotz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© WIBU BOT_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             SonelBotz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = SonelBotz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `SonelBotz`, "footerText": "*_© WIBU BOT_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
│
└───「 \`\`\`WIBU BOT\`\`\` 」`
sendButLocation(from, `${menu}`, "*_© WIBU BOT_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'BUTTON MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
stod = `${sender}`
       stst = await SonelBotz.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = '🏴‍☠️ WIBU BOT 🏴‍☠️'
       ownerJid = "16146607969@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
...
ini_list.push({
"displayName": `Developer WIBU BOT`,
